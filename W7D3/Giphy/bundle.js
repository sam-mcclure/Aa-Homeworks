...
function GiphysIndex(_ref) {
  ...
  var GiphysIndexItems = giphys.map(function (giphy) {
...
var GiphysSeach = function (_React$Component) {
  _inherits(GiphysSeach, _React$Component);

  function GiphysSeach(props) {
    _classCallCheck(this, GiphysSeach);

    var _this = _possibleConstructorReturn(this, (GiphysSeach.__proto__ || Object.getPrototypeOf(GiphysSeach)).call(this, props));
